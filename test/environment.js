...
exports['test environemnt bindings'] = function () {
...
exports['test environment bindings with parent'] = function () {
...
exports['test environment with deeper hierarchy'] = function () {
  var par = Environment.createEnvironment();
  par.put(key1, val1);
